...
A further modification can be made such that the accuracy of X's prediction is no longer close to 100% but e.g. only 50%. In that case we can effectively replace X by a coin-toss or a dice-roll. The scenario then becomes a gamble and the choice you make is simply a reflection on how risk-seeking (how much of a gambler) you are.
